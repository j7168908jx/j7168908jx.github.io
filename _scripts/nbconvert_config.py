...
# c.MarkdownExporter.template_paths = jupyter_path('nbconvert','templates') # List of paths to user's Jupyter templates directories
c.MarkdownExporter.template_paths = [this_script_dir] + jupyter_path('nbconvert','templates')   # List of paths to user's Jupyter templates directories
